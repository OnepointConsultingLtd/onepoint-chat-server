  ...
  return (
    <div className="flex items-center justify-center p-4">
      <div className="relative max-w-lg w-full">
        ...
        {/* Main card */}
        <div className="relative bg-[color:var(--osca-bg-light)] dark:!bg-[color:var(--osca-bg-dark)] rounded-2xl shadow-2xl overflow-hidden border border-red-200 dark:border-red-800/50 backdrop-blur-sm">
          ...
          <div className="relative p-4">
            ...
            {/* Title */}
            <h3 className="text-2xl font-bold text-center text-gray-900 dark:!text-[color:var(--osca-text-on-dark)] mb-2 tracking-tight">
              {title}
            </h3>
          ...
          <div className="px-8 py-6 bg-gray-50/50 dark:bg-gray-800/50 backdrop-blur-sm">
            <div className="flex items-start gap-3">
              ...
              <p className="text-gray-700 dark:!text-[color:var(--osca-text-on-dark)] leading-relaxed text-base">
                {message}
              </p>
            </div>
          </div>
